...
class ProductTemplate(models.Model):
    ...
    tax_benefit = fields.Char(string="Tax benefit", translate=True)
    fees = fields.Html(string="Subscription_fees", translate=True)
    minimum_amount = fields.Monetary(
        string="Minimum subscription amount", currency_field="currency_id"
    )
    maximum_amount = fields.Monetary(
        string="Maximum subscription amount", currency_field="currency_id"
    )
    access_terms = fields.Char(string="Terms of access", translate=True)
    max_target_issue = fields.Monetary(
        string="Issue total amount", currency_field="currency_id"
    )
